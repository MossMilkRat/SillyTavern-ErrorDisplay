// Error Display Extension for SillyTavern
// Displays API errors, generation failures, and system errors in a UI panel
...
(function() {
    ...
    jQuery(async () => {
        ...
        // Listen for generation errors if eventSource is available
